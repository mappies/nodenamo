...
describe('Query.Find', function ()
{
    ...
    {
        findResult.lastEvaluatedKey = 'eyJrZXkiOjF9';
    ...
    {
        mockedManager.setup(m => m.find(Entity, keyCondition, undefined, {exclusiveStartKey: 'eyJrZXkiOjF9'})).callback(()=>called=true).returns(async()=>findResult);
    ...
    {
        mockedManager.setup(m => m.find(Entity, keyCondition, undefined, {limit: 1, fetchSize: undefined, indexName:'index-name', order: 1, exclusiveStartKey: 'eyJrZXkiOjF9'})).callback(()=>called=true).returns(async()=>findResult);
    ...
    {
        mockedManager.setup(m => m.find(Entity, keyCondition, undefined, {limit: 1, fetchSize: undefined, indexName:'index-name', order: 1, exclusiveStartKey: 'eyJrZXkiOjF9', projections: ["p1", "p2"]})).callback(()=>called=true).returns(async()=>findResult);
    ...
    {
        mockedManager.setup(m => m.find(Entity, keyCondition, filterCondition, {exclusiveStartKey:'eyJrZXkiOjF9'})).callback(()=>called=true).returns(async()=>findResult);
    ...
    {
        mockedManager.setup(m => m.find(Entity, keyCondition, filterCondition, {limit: 1, fetchSize: undefined, indexName:'index-name', order: 1, exclusiveStartKey: 'eyJrZXkiOjF9'})).callback(()=>called=true).returns(async()=>findResult);
    ...
    {
        mockedManager.setup(m => m.find(Entity, keyCondition, filterCondition, {limit: 1, fetchSize: undefined, indexName:'index-name', order: 1, exclusiveStartKey: 'eyJrZXkiOjF9', projections: ["p1"]})).callback(()=>called=true).returns(async()=>findResult);
    ...
    {
        mockedManager.setup(m => m.find(Entity, keyCondition, filterCondition, {limit: 1, fetchSize: undefined, indexName:'index-name', order: 1, exclusiveStartKey: 'eyJrZXkiOjF9', projections: ["p1"], stronglyConsistent: true})).callback(()=>called=true).returns(async()=>findResult);
    ...
    it('list(projections).from.by.filter.limit.using.order.resume()', async ()=>
    {
        ...
        mockedManager.setup(m => m.find(Entity, listKeyCondition, filterCondition, {limit: 1, fetchSize: undefined, indexName:'index-name', order: 1, exclusiveStartKey: 'eyJrZXkiOjF9', projections: ["p1", "p2"]})).callback(()=>called=true).returns(async()=>findResult);
    ...
    it('list(projections).from.by.filter.limit.using.order.resume.stronglyConsistent()', async ()=>
    {
        ...
        mockedManager.setup(m => m.find(Entity, listKeyCondition, filterCondition, {limit: 1, fetchSize: 2, indexName:'index-name', order: 1, exclusiveStartKey: 'eyJrZXkiOjF9', projections: ["p1", "p2"], stronglyConsistent: true})).callback(()=>called=true).returns(async()=>findResult);
